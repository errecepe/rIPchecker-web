...
elseif (isset($_POST['reserva_dir_id'])){
	if (isset($_POST['frm_notas'])){
		...
		$sql_reserva="UPDATE direccionamiento SET dir_reservado=1 ,  dir_notas='" . utf8_decode($_POST['frm_notas']) . "' where dir_id=" . $_POST['reserva_dir_id'];
